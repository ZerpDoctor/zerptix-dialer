...
_CALL_AUDIO_SYSTEM = (
    ...
    "or more words is not itself a reason for low confidence. When the transcript "
    "truly gives no real signal either way, prefer confidence low rather than guessing. "
    "Reply with ONLY a JSON object, no prose, with keys: "

...
_ALT_CONTACT_SYSTEM = (
    ...
    "[a different number]...' -- a redirect to ANOTHER PHONE NUMBER counts "
    "exactly the same as a text/email/website redirect: the caller will not "
    "reach anyone by continuing on THIS call), OR by two other confirmed "
